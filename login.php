...
<!-- <script>
        function onHandleAlert() {
            var error = document.getElementById('div-error');
...
if (isset($_POST['dangnhap'])) 
{
    ...
    $sql="SELECT username, password FROM congdan WHERE username='$username'";
		...
		<div class="container-login100" >
            ...
            <img src="img/logobtp.png">
					...
					<span class="login100-form-title p-b-34 p-t-27">
						Đăng Nhập Vào Trang Web Đăng Ký Khai BÁo Tình Trạng Hôn Nhân 
					</span>
                    ...
                    <div style="padding-bottom: 50px; text-align: right;">
                        ...
                        <a class="" style="color: white" href="http://localhost/honnhangiadinh/admin.php">
                            <u>Admin</u>
                        </a></p>
