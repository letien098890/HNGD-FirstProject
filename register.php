...
<body>
		...
		<div class="container-login100" >
			<div class="wrap-login101">
				<form class="" action="http://localhost/honnhangiadinh/xulydangky.php" method="POST">
					<span class="">
						<div align="center">	<span class="" >
						<a href="">
            <img src="img/logobtp.png">
        </a>
					</span></div>
					</span>

					<span class="login100-form-title p-b-34 p-t-27">
						Đăng Kí Tài Khoản Công Dân 
					</span>
					...
					<div class="wrap-input100 validate-input" data-validate = "">
						<input class="input99" type="text" name="CMND">
					...
					<div style="color: white; margin: 2px;">Quốc Tịch:</div>
					<div class="wrap-input100 validate-input" data-validate = "">
						<input class="input99" type="text" name="quoctich">
						</div>

					<div style="color: white; margin: 2px;">Dân Tộc:</div>
					<div class="wrap-input100 validate-input" data-validate = "">
						<input class="input99" type="text" name="dantoc">
					</div>
...
<!-- 
					<div class="text-center p-t-90">
						...
						<a class="" style="color: white" href="http://localhost/honnhangiadinh/login.php">
							<u>Đăng Nhập Ngay?</u>
						</a></p>
